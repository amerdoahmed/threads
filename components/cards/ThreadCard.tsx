...
const ThreadCard = ({
    ...
    return(
        <article className={`flex w-flex flex-col rounded-xl 
                ...
                <div className="flex w-full flex-1 flex-row gap-4">
                    ...
                    <div className={`${isComment && "mb-10"} mt-5 flex flex-col gap-3`}>
                        <div className="flex gap-3.5">
                            ...
                            <Link href={`thread/${id}`}>
                            <Image src="/assets/reply.svg" alt = "replay" width={24}
                            height={24} className="cursor-pointer object-contain"/>
                            </Link>
                        ...
                        {isComment && comments.length > 0 && (
                            <Link href={`thread/${id}`}>
                                <p className="mt-1 text-subtl-medium text-gray-1">{comments.length} replies</p>
                            </Link>
                        )}
                    </div>
